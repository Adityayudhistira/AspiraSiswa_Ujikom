            ...
            <div class="bg-white shadow-2xl rounded-3xl overflow-hidden">
                ...
                <div class="p-8 space-y-6">
                    ...
                    <form action="{{ route('admin.category.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="ket_category" class="block font-semibold mb-2 text-gray-700">
                                Nama Kategori <span class="text-red-500">*</span>
                            </label>

                            <input type="text" id="ket_category" name="ket_category" value="{{ old('ket_category') }}"
                                maxlength="30" required autofocus placeholder="Contoh: Fasilitas"
